  ...
  return (
    <div className="bg-white py-8 relative overflow-hidden">
      ...
      <SectionHeader
        ...
        description="Our partners and sponsors help us build Africa’s innovation ecosystem — supporting founders, startups, and creative entrepreneurs to grow and scale. We’re proud to collaborate with visionary organizations who believe in the power of innovation to transform communities."
      />
